...
export default function LoginPage() {
  const { login, signup, loginWithOAuth, resetPassword, updatePassword } = useAuth();
              ...
              <div className="text-center text-sm text-gray-600 dark:text-gray-400 space-y-2">
                {mode === 'login' && (
                  <p>
                    ...
                    <button type="button" className="text-[#0073EA] hover:underline font-medium" onClick={() => switchMode('signup')}>
                      Sign Up
                    </button>
                  </p>
                )}
                {mode === 'signup' && (
                  <p>
                    ...
                    <button type="button" className="text-[#0073EA] hover:underline font-medium" onClick={() => switchMode('login')}>
                      Log In
                    </button>
                  </p>
                )}
                {(mode === 'forgot' || mode === 'reset') && (
                  <button
                    type="button"
                    className="text-[#0073EA] hover:underline font-medium inline-flex items-center gap-1"
